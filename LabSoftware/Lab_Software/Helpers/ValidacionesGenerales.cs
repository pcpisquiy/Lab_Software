...
namespace Lab_Software.Helpers
{
    ...
    public class ValidacionesGenerales
    {
        ...
        /// <returns></returns>
        public bool ValidarCorreo(string _correo, List<string> _listaCorreosRegistrados)
        {
            return correoRegex.IsMatch(_correo) && !_listaCorreosRegistrados.Contains(_correo);
        }
